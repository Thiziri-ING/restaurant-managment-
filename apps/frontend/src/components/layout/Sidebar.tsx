...
const navItems = [
  { to: '/manager',      label: 'Tableau de bord', icon: LayoutDashboard, roles: ['MANAGER'] },
  { to: '/caisse',       label: 'Interface Caisse',  icon: ShoppingCart,    roles: ['MANAGER', 'CAISSIER'] },
  { to: '/cash',         label: 'Caisse (session)',   icon: DollarSign,      roles: ['MANAGER', 'CAISSIER'] },
  { to: '/stock-manager', label: 'Stock',             icon: Package,         roles: ['MANAGER', 'MAGASINIER'] },
